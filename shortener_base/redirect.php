 ...
 * Developer and is Andreas Wierz. All portions of the code written by Andreas
 * Wierz are Copyright (c) 2012. All Rights Reserved.
 * Contributor(s):
...
{
    $url = $sTemplate->getRoot()."unfollow.php?qId=".$id->val();
}
