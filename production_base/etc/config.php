...
define("SPONSOR_LOGOS",         "http://de.wikiarguments.net/sponsors/");
define("SPONSOR_LOGOS_ABS",     "<path to wikiarguments instance>/uploads/sponsors/");
...
define("SIGNUP_REQUIRE_TOKEN",              false);
define("PHPSPELLCHECK_ENABLED",             false);
define("PHPSPELLCHECK_ROOT",                SITE_ROOT."spellcheck/");
define("VOTES_AJAX",                        true);

define("QUESTIONS_PER_PAGE",                10);
define("SPONSORS_PER_PAGE",                 11);
...
{
    $glob = Array(DATABASE_USERS, DATABASE_LOCALIZATION);
