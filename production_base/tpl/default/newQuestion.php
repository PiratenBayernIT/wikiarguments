...
<div id = "btn_spellcheck_question" class = "spellcheck_button"></div>
<script type = "text/javascript">wikiargument.initSpellcheck('new_question_title', 'btn_spellcheck_question', 'de');</script>
<? } ?>
          </div>
        </div>
...
<? if(PHPSPELLCHECK_ENABLED) { ?>
<div id = "btn_spellcheck_details" class = "spellcheck_button"></div>
<script type = "text/javascript">wikiargument.initSpellcheck('new_question_details', 'btn_spellcheck_details', 'de');</script>
<? } ?>
          </div>
        </div>
